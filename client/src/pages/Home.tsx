    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: Lock, title: "Персональные данные", desc: "Соответствует ли работа с данными требованиям 152-ФЗ" },
            ...
            <div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  { title: "Ключевые риски с последствиями", desc: "До 5 рисков с денежными последствиями, влиянием на бизнес и ссылками на ГК РФ, КоАП, 152-ФЗ" },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                {[
                  { icon: Scale, title: "Основано на реальных нормах", desc: "Каждый риск привязан к конкретным статьям ГК РФ, КоАП, 152-ФЗ и другим актуальным нормам" },
            ...
            <div className="space-y-4">
              {[
                { label: "Права на продукт", law: "Ст. 1228, 1234, 1296 ГК РФ" },
                { label: "Персональные данные", law: "Федеральный закон № 152-ФЗ" },
                { label: "Защита потребителей", law: "Закон РФ № 2300-1" },
                { label: "Хранение данных", law: "Ст. 18 Федерального закона № 152-ФЗ" },
                { label: "Платёжная модель", law: "Ст. 1005–1011 ГК РФ; 173-ФЗ" },
              ].map((item, i) => (
      ...
      <footer className="section-dark py-10 border-t border-white/8">
        <div className="container flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/30 text-xs">© 2024 Neolex</p>
        </div>
      </footer>
    </div>
  );
