...
const R2_0012_TABLES = ["r1_document_manifests"] as const;
const R2_0013_TABLES = ["r1_document_text_artifacts"] as const;
...
const REQUIRED_FOREIGN_KEYS = [
  ...
  "fk_r1_document_manifest_case_owner",
  "fk_r1_document_manifest_grant_owner_case",
  "fk_r1_document_text_artifact_manifest_owner_case",
] as const;
...
const REQUIRED_INDEXES = [
  ...
  "r1_document_manifests_id_owner_case_uq",
  "r1_document_manifests_case_hash_uq",
  "r1_document_manifests_owner_case_status_idx",
  "r1_document_text_artifacts_queue_idx",
  "r1_document_text_artifacts_owner_case_idx",
] as const;
...
const R2_0012_MIGRATION_NAME = "0012_r1_document_manifest.sql";
const R2_0013_MIGRATION_NAME = "0013_r2_document_text_artifacts.sql";
const MIGRATION_NAMES = [
  ...
  R2_0012_MIGRATION_NAME,
  R2_0013_MIGRATION_NAME,
] as const;
...
describe("R1 disposable database schema and constraints", () => {
  ...
  it("has exactly the expected 27 R1/R2 tables, 36 foreign keys, and required indexes", async () => {
    const database = await db();
    ...
    expect(V2_TABLES).toHaveLength(27);
    ...
    expect(foreignKeyNames).toHaveLength(36);
