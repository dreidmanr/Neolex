...
${
  ...
  <div class="disclaimer" style="margin-top:32px">
    <div class="risk-field-label" style="margin-bottom:6px">Важное уведомление</div>
    <div class="disclaimer-text">Данная диагностика носит информационный характер и не является юридической консультацией. Результаты основаны на ваших ответах. Для получения юридически значимых выводов необходима работа с реальными документами. Сервис Lexy by Neolex.<br/>Колунова Рада Янушевна · ИНН 402404019964 · НПД (самозанятая) · kolunovarada@yandex.ru</div>
  </div>
</div>`
    : ""
}
